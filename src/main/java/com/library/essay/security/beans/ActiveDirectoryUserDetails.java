...
/**
 * This class is used to capture extra user attributes from Active Directory
 * upon authentication
 * 
 * @author yunpeng.li
 *
...
public class ActiveDirectoryUserDetails implements LdapUserDetails {
	...
	public String toString() {
		return "Dn=" + this.getDn() + ", displayName=" + this.displayName + ", company=" + this.company + ", email="
				+ this.email + ", sAMAccountName=" + this.sAMAccountName + ", telephoneNumber=" + this.telephoneNumber
				+ ", title=" + this.title + ", userPrincipalName=" + this.userPrincipalName + ", streetAddress="
				+ this.streetAddress + ", location=" + this.location + ", state=" + this.state;
	}
