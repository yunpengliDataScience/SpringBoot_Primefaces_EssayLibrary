...
@Component("essayBeanViewScope")
@Scope("view")
public class EssayBeanViewScope implements Serializable {

  private static final long serialVersionUID = 1L;
  private Logger logger = LoggerFactory.getLogger(getClass());
  
  private static final String PAGE="essayViewScope.xhtml";
