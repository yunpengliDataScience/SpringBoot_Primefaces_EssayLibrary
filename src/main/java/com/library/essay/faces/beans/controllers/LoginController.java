...
/**
 * LoginController implements PhaseListener in order to generate error messages when redisplaying
 * the login page. This PhaseListener should be registered in faces-config.xml.
 * 
 * @author yunpeng.li
 *
 */
